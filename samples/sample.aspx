<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmFormSuppliesInfoLY.aspx.cs"
    Inherits="DirOfficeSupplies_frmFormSuppliesInfoLY" %>

<%@ Register Src="../UserContorl/ucGongWenConceit.ascx" TagName="Conceit" TagPrefix="uc1" %>
<%@ Register Src="../UserContorl/ScriptManager.ascx" TagName="ScriptManager" TagPrefix="uc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>坚实的开了房间是老款的积分</title>
    <link href="../css/style.css" rel="stylesheet" type="text/css" />
    <script src="../Include/GongWenPageCheck.js" type="text/javascript"></script>
...
<body>
    ...
    <form id="form1" runat="server">
            ...
            <table width="1100" border="0" align="center">
                    ...
                    <td>
                        <table cellspacing="2" width="100%" border="0">
                            <tr style="height: 25px;">
                                <td width="25%">
                                    <b>当前处理状态: &nbsp;<asp:Label ID="conCurStatus" runat="server"></asp:Label></b></td>
                                <td width="25%">
                                    <b>当前处理人: &nbsp;<asp:Label ID="conCurUserName" runat="server"></asp:Label></b></td>
                                <td align="right" width="25%">
                                    <b>日期: &nbsp;<asp:Label ID="conCurDate" runat="server"></asp:Label></b></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                        ...
                        <table class="dgTbl" cellspacing="0" cellpadding="1" rules="all" border="1" width="100%" align="center">
                            <tr>
                                ...
                                <td align="left" colspan="3">
                                    <asp:TextBox ID="conTitle" runat="server" MaxLength="200" CssClass="input_text" Width="98%">广东省公路事务中心办公用品申领表</asp:TextBox></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td align="left" width="35%">
                                    <asp:Label ID="conNiGaoDeptName" runat="server" MaxLength="50" Width="50%"></asp:Label></td>
                                <td class="rpF" width="15%">&nbsp;申请人
                                </td>
                                <td align="left" width="35%">
                                    <asp:Label ID="conNiGaoUserName" runat="server" MaxLength="50" Width="50%"></asp:Label></td>
                            </tr>
                            <tr align="center" width="100%">
                                <td colspan="4">
                                    ...
                                    <%if((Convert.ToInt32(this.CurNodeID)==2||Convert.ToInt32(this.CurNodeID)==4||Convert.ToInt32(this.CurNodeID)==5||Convert.ToInt32(this.CurNodeID)==6||Convert.ToInt32(this.CurNodeID)==7||Convert.ToInt32(this.CurNodeID)==8||Convert.ToInt32(this.CurNodeID)==9)&& this.PageEditType==2){%>
                                    ...
                                    <div style="height: 180px; overflow-y: auto; overflow-x: hidden">
                                        <table class="dgTbl" cellspacing="0" cellpadding="1" rules="all" border="1" width="100%">
                                            <asp:Repeater ID="rpList1" runat="server">
                                                ...
                                                <ItemTemplate>
                                                    <tr class="rpI">
                                                        <td align= "left" >&nbsp;<%#DataBinder.Eval(Container.DataItem, "FIXEDName")%></td>
                                                        ...
                                                        <td align="center">【<%#DataBinder.Eval(Container.DataItem, "DeptName")%>】<%#DataBinder.Eval(Container.DataItem, "username")%></td>
                                                        <td align="center"><%#DataBinder.Eval(Container.DataItem, "ShiYongR")%></td>
                                                        <td align="center"><%#DataBinder.Eval(Container.DataItem, "getway")%></td>
                                                        <td align="center"><%#Eval("GetDate1","{0: yyyy-MM-dd}").Replace('/','-')%></td>
                                                        <td align= "left" >&nbsp;<%#DataBinder.Eval(Container.DataItem, "remark")%></td>
                                                        <td align="center"><%#GetShiYongZK(DataBinder.Eval(Container.DataItem, "islock").ToString())%></td>
                                    ...
                                    <div style="margin-left: auto; overflow: auto; width: 100%; margin-right: auto; max-height: 300px">
                                        <table class="dgTbl" cellspacing="0" cellpadding="1" rules="all" width="100%" align="center"
                                            ...
                                            <tr class="rpH">
                                                ...
                                                <td width="10%">用品名称</td>
                                                <td width="10%">品牌型号</td>
                                                <%if(Convert.ToInt32(this.CurNodeID)>=2||Convert.ToInt32(this.CurNodeID)==0){%>
                                                <td width="8%">审核数量</td>
                                                <%}%>

                                                <%if((Convert.ToInt32(this.CurNodeID)==5||Convert.ToInt32(this.CurNodeID)==6||Convert.ToInt32(this.CurNodeID)==7||Convert.ToInt32(this.CurNodeID)==8||Convert.ToInt32(this.CurNodeID)==9||Convert.ToInt32(this.CurNodeID)==99)&& this.PageEditType==2){%>
                                                <td width="8%">库存</td>
                                                <%}%>

                                                <td width="11%">使用人</td>
                                                <td width="28%">备注说明</td>
                                                <%if(this.CurNodeID=="99"&& this.PageEditType==2){ %>
                                                <td width="8%">资产编号</td>
                                                <td>添加资<br />
                                                    产编号</td>
                                                <%}%>
                                                <%if(this.CurNodeID=="1"&& (this.PageEditType==1||this.PageEditType==2)){ %>
                                                <td width="10%"></td>
                                                <%} %>
                                                <%if((Convert.ToInt32(this.CurNodeID)==2||Convert.ToInt32(this.CurNodeID)==4||Convert.ToInt32(this.CurNodeID)==5||Convert.ToInt32(this.CurNodeID)==6||Convert.ToInt32(this.CurNodeID)==7||Convert.ToInt32(this.CurNodeID)==8||Convert.ToInt32(this.CurNodeID)==9)&& this.PageEditType==2){%>
                                                <td width="10%">审核</td>
                            ...
                            <tr style="display: none">
                                ...
                                <td id="Td7" align="left" colspan="3" runat="server">
                                    <asp:TextBox ID="conRemark" runat="server" MaxLength="200" CssClass="input_text" Width="98%"></asp:TextBox></td>
                            </tr>
                            <tr runat="server" id="trVerify">
                                <td class="rpF"><span style="color: red">*</span>发放核对</td>
                                <td align="left" colspan="3">
                                    <asp:TextBox ID="conVerify" runat="server" MaxLength="200" CssClass="input_text" Width="98%"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td colspan="6">
                                    <uc1:Conceit ID="conConceitInfo" runat="server" />
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td align="center" style="height: 40px; vertical-align: middle;" colspan="6">
                        ...
                        <asp:Button ID="btnSummary" runat="server" CssClass="input_btn2" Text="用品缺少汇总" />
        ...
        <div style="display: none">
            <!--卡死了；看风景阿斯利康健康理发店-->
            <asp:Label runat="server" ID="lblFlowMBID" Text="SuppliesInfoLY_Flow" />
            <!--上课就到了房间阿路上看到积分开了-->
            <asp:Label runat="server" ID="lblFormMBID" Text="SuppliesInfoLY_Page" />
            <!--数据库两地分居埃里克的-->
            <asp:Label runat="server" ID="conUnitID" />
            <!--是看得见放辣椒水电费；就-->
            <asp:Label runat="server" ID="conFlowID" />
            <uc1:ScriptManager ID="ScriptManager1" runat="server" />
    ...
    <script type="text/javascript">
        function SelectLY() {
            var url = '../DirOfficeSupplies/frmSuppliesInfoLYSelect.aspx?FlowID=<%=this.FlowID%>';
            art.dialog.open(url, {
                id: 'SelectLY',
                title: '选择用品',
                width: '80%',
        ...
        function AddEdit(value) {
            var url = '../DirOfficeSupplies/frmSuppliesInfoLYAddEdit.aspx?FlowID=<%=this.FlowID%>&ID=' + value + '&type=edit';
            art.dialog.open(url, {
                id: 'AddEdit',
                title: '阿斯蒂芬斯蒂芬',
                width: '80%',
        ...
        function AlreadySupplies(value) {
            var url = '../DirOfficeSupplies/frmAlreadySupplies.aspx?&ID=' + value;
            art.dialog.open(url, {
                id: 'AlreadySupplies',
                title: '阿斯顿发大水发',
                width: '80%',
        ...
        function SelectHenJi(value) {
            var url = '../DirOfficeSupplies/frmAuditHenJi.aspx?flowid=<%=this.FlowID %>'
            art.dialog.open(url, {
                id: 'SelectHenJi',
                title: '阿斯顿发送到',
                width: '800px',
        ...
        function AuditEdit(value) {
            var url = '../DirOfficeSupplies/frmAuditEdit.aspx?flowid=<%=this.FlowID %>&ID=' + value;
            art.dialog.open(url, {
                id: 'AuditEdit',
                title: '阿士大夫撒旦',
                width: '80%',
        ...
        function AddEditKpNo(value) {
            var url = '../DirOfficeSupplies/frmAddEditKpNo.aspx?&ID=' + value;
            art.dialog.open(url, {
                id: 'AddReflesh',
                title: '水电水电费费',
                width: '100%',
